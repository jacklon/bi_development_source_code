...
import {_c_register_components_object} from '@src/plugins/index'
         ...
         onDrop(e){
             ...
             .then((res) => {
                 if(res.code === 200){
                     ...
                     this.$set(dynamicConfig.props[0].fields[1].value[0].value,"value",parseInt(left));
                     this.$set(dynamicConfig.props[0].fields[1].value[1].value,"value", parseInt(top));
