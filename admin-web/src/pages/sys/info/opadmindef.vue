<template>
  <div class="app-container">
    ...
    <!-- 选择操作员对话框 -->
    <el-dialog :title="'选择操作员'" :close-on-click-modal="false" v-if="dialogSelUserVisible" :visible.sync="dialogSelUserVisible" width="80%">
      <div class="app-container">
        <!-- 查询和其他操作 -->
    ...
    <!-- 添加或修改对话框 -->
    <el-dialog :title="textMap[dialogStatus]" :close-on-click-modal="false" customClass="customWidth" v-if="dialogFormVisible" :visible.sync="dialogFormVisible"  >
      <div >
        <el-card >
    ...
    <!-- 查看可用变量 -->
    <el-dialog  title="查看可用变量" :close-on-click-modal="false" customClass="customWidth" v-if="dialogListParasVisible" :visible.sync="dialogListParasVisible"  >
