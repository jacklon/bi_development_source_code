...
import org.java.bi.core.util.SystemInfoPrinter;
...
public class SystemInistService {
    ...
    @Autowired
    private SysSetService litemallSystemConfigService;
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.java.bi.wx"));
