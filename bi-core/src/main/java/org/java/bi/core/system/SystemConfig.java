package org.java.bi.core.system;
...
public class SystemConfig {
    ...
    //接口有关
    public final static String LITEMALL_MALL_DAXING_APP_ACCOUNT = "litemall_mall_daxing_app_account";
    public final static String LITEMALL_MALL_DAXING_APP_PASSWORD = "litemall_mall_daxing_app_password";
    public final static String LITEMALL_MALL_SHOUDU_CRM_ACCOUNT = "litemall_mall_shoudu_crm_account";
    public final static String LITEMALL_MALL_SHOUDU_CRM_PASSWORD = "litemall_mall_shoudu_crm_password";
    public final static String LITEMALL_MALL_DAXING_CRM_ACCOUNT = "litemall_mall_daxing_crm_account";
    public final static String LITEMALL_MALL_DAXING_CRM_PASSWORD = "litemall_mall_daxing_crm_password";

    public final static String LITEMALL_MALL_KECHUAN_CRM_ADDRESS = "litemall_mall_kechuan_crm_address";
    public final static String LITEMALL_MALL_DAXING_PC_ADDRESS = "litemall_mall_daxing_pc_address";
    ...
    public static String getDaxingAppAccount() {
        return getConfig(LITEMALL_MALL_DAXING_APP_ACCOUNT);
    }
    public static String getDaxingAppPassword() {
        return getConfig(LITEMALL_MALL_DAXING_APP_PASSWORD);
    }
    public static String getShouduCrmAccount() {
        return getConfig(LITEMALL_MALL_SHOUDU_CRM_ACCOUNT);
    }
    public static String getShouduCrmPassword() {
        return getConfig(LITEMALL_MALL_SHOUDU_CRM_PASSWORD);
    }
    public static String getDaxingCrmAccount() {
        return getConfig(LITEMALL_MALL_DAXING_CRM_ACCOUNT);
    }
    public static String getDaxingCrmPassword() {
        return getConfig(LITEMALL_MALL_DAXING_CRM_PASSWORD);
    }

    public static String getKechuanCrmAddress() {
        return getConfig(LITEMALL_MALL_KECHUAN_CRM_ADDRESS);
    }
    public static String getDaxingPcAddress() {
        return getConfig(LITEMALL_MALL_DAXING_PC_ADDRESS);
    }
