 ...
 * 访问方式  http://localhost:9910/swagger-ui.html#/
 */
@Configuration
@EnableSwagger2
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).
                ...
                select()
                // 为当前包路径
                .apis(RequestHandlerSelectors.basePackage("org.java.bi.admin.web"))
    ...
    public Docket wap_api() {
        return new Docket(DocumentationType.SWAGGER_2).
                ...
                select()
                // 为当前包路径
                .apis(RequestHandlerSelectors.basePackage("org.java.bi.wx.web"))
                .paths(PathSelectors.any())
                .build()
                .groupName("WEB接口文档V1");
//        return new Docket(DocumentationType.SWAGGER_2).
...
//                .apiInfo(apiInfo("WEB接口文档V4.4及之前","文档中可以查询及测试接口调用参数和结果","4.4"));
    ...
    public Docket out_api() {
        return new Docket(DocumentationType.SWAGGER_2).
                ...
                select()
                // 为当前包路径
                .apis(RequestHandlerSelectors.basePackage("org.java.bi.out.control.visited"))
                .paths(PathSelectors.any())
                .build()
