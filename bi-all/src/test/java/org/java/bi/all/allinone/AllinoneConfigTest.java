...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.org.java.bi.wx"));
        System.out.println(environment.getProperty("logging.level.org.java.bi.admin"));
        System.out.println(environment.getProperty("logging.level.org.java.bi"));
        System.out.println(environment.getProperty("logging.level.org.java.bi.api"));
    }
