...
import org.java.bi.admin.util.CommonService;
import org.java.bi.admin.util.ProcessLinuxShellUtil;
...
public class CommonLogController {
    private final Log logger = LogFactory.getLog(CommonLogController.class);

    @Autowired
    private CommonService commonService;

//    @RequiresPermissions("admin:commonLog:getLogSetting")
//    @RequiresPermissionsDesc(menu={"维护工具" , "获取日志文件路径"}, button="获取路径")
...
//    @RequiresPermissionsDesc(menu={"维护工具" , "设置日志文件路径"}, button="保存路径")
