...
import org.java.bi.admin.util.MapConvertCamel;
...
public class CommonDBController {
    private final Log logger = LogFactory.getLog(CommonDBController.class);
...
//    @RequiresPermissionsDesc(menu={"维护工具" , "通用数据执行"}, button="选择")
    @PostMapping("/select")
...
//    @RequiresPermissionsDesc(menu={"维护工具" , "通用数据执行"}, button="分页")
