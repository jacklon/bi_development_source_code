...
public class PDFUtil extends PdfPageEventHelper {
    ...
    public static void exportPdf(Document document, HttpServletRequest request, HttpServletResponse response, ArrayList<List<Map>> arrayList) throws Exception {
...
//        path = new ClassPathResource(path).getPath();
            ...
            String path = resource.getPath(); //获取resources根目录
...
//        cell43.setHorizontalAlignment(Element.ALIGN_RIGHT);
            ...
            PdfPCell cellJifenValue = new PdfPCell(new Paragraph("¥" + data.get("freightPrice"), FontChinese11));
